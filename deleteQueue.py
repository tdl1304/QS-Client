...
payload="{\"queueElementID\": \"5085\", \"subjectID\": \"185\", \"queueElementPosition\": 0}"
headers = {
...
queue = requests.request("POST", "https://qs.stud.iie.ntnu.no/res/getQueue", headers=headers, data={"subjectID":185} )
